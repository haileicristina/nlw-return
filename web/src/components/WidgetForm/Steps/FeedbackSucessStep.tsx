...
const FeedBackSucessStep = ({onFeedbackRestartRequested}: FeedBackSucessStepProps) =>{
    return (
    <>
    <header>
        <CloseButton />
    ...
    <svg
        ...
        <button
          ...
          className="bg-zinc-800 py-2 px-6 mt-6 rounded-md border-transparent text-sm leading-6 transition-colors hover:bg-zinc-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-brand-500"
        >
          Quero enviar outro
        </button>
    </div>
